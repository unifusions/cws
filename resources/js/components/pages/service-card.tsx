...
export default function ServiceCard({ service, progress, i, range, targetScale, targetOpacity }: any) {
    ...
    return (
        ...
        <motion.div className=" bg-white sticky top-45 md:top-60"
            style={{
                // scale,
                opacity,
 ...
 <h2 className="text-6xl   text-accent-secondary/20 md:text-8xl xl:text-9xl  ">
                    [{service.label_no}]
                </h2>
                    </div>
                    <div className="col-span-3">
   <h1 className="text-4xl md:text-5xl  xl:text-6xl font-bold tracking-tighter md:max-w-3/4 mb-3">
